<template>
	<header class="banner">
		...
		<img
			src="@/assets/images/fundo-banner.png"
			alt="Foto de uma mulher cozinhando com uma bacia de vidro nas mãos. Ela está sorrindo e está apoiando um celular entre seu rsto e ombro."
			class="foto-banner"
		/>
	</header>
</template>
